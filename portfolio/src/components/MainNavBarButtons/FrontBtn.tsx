...
let thisBtnClass = " justify-end self-center max-xl:w-[80%] max-xl:h-16 xl:w-48 xl:h-24 hover:w-64 hover:cursor-pointer transition-hoverScale ease-in-out duration-300 xl:mr-[-2em] rounded-md border-hidden order-3 z-40 bg-Idle hover:bg-FrontBtn "

function FrontBtn({state, setState, previousState, isDesktop}:StringBtnProp)
{
